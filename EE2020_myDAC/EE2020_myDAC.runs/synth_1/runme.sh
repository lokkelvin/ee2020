...
HD_PWD='D:/Desktop/MyWork/EE2020_myDAC_square_gen_working.xpr/EE2020_myDAC_monday morning.xpr/EE2020_myDAC/EE2020_myDAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myDAC_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myDAC_TOP.tcl
