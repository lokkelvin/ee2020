...
HD_PWD='D:/Desktop/MyWork/EE2020_myDAC_square_gen_working.xpr/EE2020_myDAC_monday morning.xpr/EE2020_myDAC/EE2020_myDAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myDAC_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myDAC_TOP.tcl -notrace
